...
3. INSERT INTO Dog
	(dogID, breed, name, weight_lbs)#might not need the attributes, test it out
	VALUES
...
10. ALTER TABLE Visit ADD bill DECIMAL(6,2) NOT NULL;
...
12. SELECT * FROM Visit;

\T assign6log.txt
 source /home/hopper/z1900146/466/Z1900146_Assign6.sql
\t